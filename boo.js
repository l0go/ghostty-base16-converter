...
Main.convertYaml = function(from) {
	try {
		var data = yaml_Yaml.parse(from,yaml_Parser.options().useObjects());
		Main.textareaOut.value = Scheme.generateGhosttyConfig(data);
